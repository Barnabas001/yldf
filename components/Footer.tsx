...
const footerLinks = {
  'Quick Links': ['Home', 'About Us', 'Trainings', 'Alumni', 'Projects', 'Gallery'],
  'Programs': ['Leadership Training', 'Mentorship', 'Community Impact', 'Alumni Network', 'Annual Summit'],
  'Support': ['Contact Us', 'FAQ', 'Privacy Policy', 'Terms of Use', 'Donate'],
}
    ...
    <footer style={{ background: 'var(--navy-dark)' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              >
                Get the latest news, trainings, and impact stories delivered to your inbox.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p
              ...
              style={{ fontFamily: 'var(--font-dm-sans)' }}
            >
              Empowering Young Leaders. Transforming Communities. Est. 2003 — for Excellence &amp; All Round Development.
            </p>
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    ...
                    >
                      <span
                        className="w-0 h-px bg-[#C99A2E] group-hover:w-3 transition-all"
                      />
                      {link}
                    </a>
                  </li>
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            {['Privacy Policy', 'Terms of Use'].map((item) => (
              <a
                key={item}
                href="#"
                className="text-white/30 hover:text-[#C99A2E] text-xs transition-colors"
                style={{ fontFamily: 'var(--font-dm-mono)' }}
              >
                {item}
              </a>
          ...
          >
            Designed with{' '}
            <span className="text-[#C99A2E]">purpose</span>.{' '}
            Built for <span className="text-[#C99A2E]">impact</span>.
          </p>
        </div>
      </div>
    </footer>
